...
from .notifier import alert_router, route_alert
from ..dashboards.annotations import annotation_manager, annotate_alert, annotate_anomaly
...
def handle_webhook(request_obj, endpoint_type: str):
    ...
    try:
        ...
        logger.info(f"Received {endpoint_type} webhook with {len(data.get('alerts', []))} alerts")
