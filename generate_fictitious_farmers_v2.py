...
def add_missing_columns():
    ...
    try:
        cursor.execute("ALTER TABLE farmers ADD COLUMN loan_status TEXT DEFAULT 'Pending'")
    ...
    try:
        cursor.execute("ALTER TABLE farmers ADD COLUMN fertilizer_cost REAL DEFAULT 0.0")
...
def main():
    ...
    cursor.execute("SELECT AVG(loan_amount), MIN(loan_amount), MAX(loan_amount) FROM farmers WHERE notes LIKE '%FICTITIOUS DATA%'")
