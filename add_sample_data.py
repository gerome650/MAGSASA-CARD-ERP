...
with app.app_context():
    ...
    products_data = [
        {
            ...
            "selling_price": 1500,
            "stock_quantity": 100,
            "description": "Complete fertilizer for rice and corn",
        },
        {
            "name": "Urea 46-0-0",
            "category": "Fertilizer",
        ...
        },
        {
            ...
            "selling_price": 4200,
            "stock_quantity": 50,
            "description": "Premium hybrid corn seeds",
        },
        {
    ...
    for product_data in products_data:
        margin_percentage = (
            (product_data["selling_price"] - product_data["cost_price"])
    ...
    partners_data = [
        {
            ...
            "company_name": "FastTrack Delivery Corp",
            "partner_type": "Logistics",
            "contact_person": "Roberto Cruz",
            "phone": "+63922678901",
            "email": "roberto@fasttrack.ph",
            "commission_rate": 8.5,
        ...
        },
        {
            ...
            "company_name": "Green Valley Agricultural Supplies Inc",
            "partner_type": "Supplier",
            "contact_person": "Linda Tan",
            "phone": "+63923789012",
            "email": "linda@greenvalley.ph",
        ...
        {
            "name": "AgriHub Solutions",
            "company_name": "AgriHub Solutions Ltd",
            "partner_type": "Both",
            "contact_person": "Michael Wong",
            "phone": "+63924890123",
            "email": "michael@agrihub.ph",
