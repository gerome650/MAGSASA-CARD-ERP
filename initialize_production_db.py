...
# Philippine crops
PHILIPPINE_CROPS = [
    "Rice", "Corn", "Sugarcane", "Coconut", "Banana", 
    "Coffee", "Cacao", "Mango", "Vegetables", "Rubber"
]

# Mobile number prefixes
MOBILE_PREFIXES = [
    "0917", "0918", "0919", "0920", "0921", "0928", "0929", "0939",
    "0908", "0909", "0910", "0912", "0930", "0938", "0946", "0947"
]
...
def create_production_database():
    ...
    farmers_data = []
    for i in range(1, 2501):  # Generate 2500 farmers
        ...
        farmer_data = (
            ...
            location, land_size, crop_types, land_tenure, farming_experience,
            agscore, agscore_grade, loan_amount, loan_status,
            'FICTITIOUS DATA - Generated for testing', registration_date.date(),
