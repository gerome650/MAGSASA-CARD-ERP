#!/usr/bin/env python3
"""
Generate 2500 fictitious farmers for AgSense ERP system
...
first_names = [
    ...
    "Francisco", "Luz", "Ricardo", "Gloria", "Roberto", "Esperanza", "Carlos", "Remedios", "Miguel", "Dolores",
    "Angel", "Concepcion", "Fernando", "Pilar", "Eduardo", "Mercedes", "Alejandro", "Soledad", "Rafael", "Teresa",
    "Joaquin", "Josefa", "Sergio", "Francisca", "Arturo", "Isabel", "Raul", "Antonia", "Enrique", "Catalina",
    "Gerardo", "Rosario", "Alberto", "Juana", "Armando", "Manuela", "Rodolfo", "Petra", "Alfredo", "Leonor",
    "Emilio", "Vicenta", "Guillermo", "Felipa", "Octavio", "Gregoria", "Salvador", "Perfecta", "Aurelio", "Marcela",
    "Domingo", "Felicidad", "Teodoro", "Purificacion", "Mariano", "Presentacion", "Esteban", "Milagros", "Leandro", "Consolacion"
]

last_names = [
    "Santos", "Reyes", "Cruz", "Bautista", "Ocampo", "Garcia", "Mendoza", "Torres", "Tomas", "Andres",
    "Marquez", "Romualdez", "Mercado", "Aguilar", "Dela Cruz", "Ramos", "Villanueva", "Aquino", "Valdez", "Soriano",
    "Castillo", "Jimenez", "Morales", "Herrera", "Perez", "Flores", "Gonzales", "Rivera", "Gomez", "Fernandez",
    "Lopez", "Hernandez", "Diaz", "Moreno", "Muñoz", "Alvarez", "Romero", "Gutierrez", "Navarro", "Ruiz",
    "Cabrera", "Bravo", "Prieto", "Molina", "Blanco", "Guerrero", "Cortez", "Medina", "Campos", "Contreras",
    "Vargas", "Figueroa", "Espinoza", "Sandoval", "Salazar", "Soto", "Maldonado", "Esquivel", "Jimenez", "Cordova"
]

# Philippine provinces and municipalities
locations = [
    {"province": "Nueva Ecija", "municipality": "Cabanatuan", "barangay": "Sangitan East"},
    ...
    {"province": "Negros Occidental", "municipality": "Bacolod", "barangay": "Taculing"},
    {"province": "Negros Occidental", "municipality": "Silay", "barangay": "Guinhalaran"},
    ...
    {"province": "South Cotabato", "municipality": "General Santos", "barangay": "Dadiangas North"}
]

# Crop types with seasonal information
crops = [
    {"name": "Rice", "season": "Wet", "cycle_months": 4, "typical_yield_per_hectare": 4.5},
    {"name": "Rice", "season": "Dry", "cycle_months": 3.5, "typical_yield_per_hectare": 5.2},
    {"name": "Corn", "season": "Wet", "cycle_months": 4, "typical_yield_per_hectare": 3.8},
    {"name": "Corn", "season": "Dry", "cycle_months": 3.5, "typical_yield_per_hectare": 4.2},
    {"name": "Sugarcane", "season": "Plant", "cycle_months": 12, "typical_yield_per_hectare": 65},
    {"name": "Sugarcane", "season": "Ratoon", "cycle_months": 10, "typical_yield_per_hectare": 55},
    {"name": "Coconut", "season": "Year-round", "cycle_months": 12, "typical_yield_per_hectare": 1.2},
    {"name": "Banana", "season": "Year-round", "cycle_months": 12, "typical_yield_per_hectare": 25},
    {"name": "Mango", "season": "Dry", "cycle_months": 6, "typical_yield_per_hectare": 8.5},
    {"name": "Coffee", "season": "Dry", "cycle_months": 6, "typical_yield_per_hectare": 1.8},
    {"name": "Cacao", "season": "Year-round", "cycle_months": 12, "typical_yield_per_hectare": 0.8},
    {"name": "Sweet Potato", "season": "Dry", "cycle_months": 3, "typical_yield_per_hectare": 12},
    {"name": "Cassava", "season": "Wet", "cycle_months": 8, "typical_yield_per_hectare": 18},
    {"name": "Peanut", "season": "Dry", "cycle_months": 3.5, "typical_yield_per_hectare": 2.2},
    {"name": "Soybean", "season": "Wet", "cycle_months": 3, "typical_yield_per_hectare": 1.8}
]

# Fertilizer types with costs
fertilizers = [
    {"name": "Urea (46-0-0)", "cost_per_bag": 1250, "application_rate_per_hectare": 3},
    {"name": "Complete (14-14-14)", "cost_per_bag": 1180, "application_rate_per_hectare": 4},
    {"name": "Ammosul (21-0-0)", "cost_per_bag": 980, "application_rate_per_hectare": 3.5},
    {"name": "Muriate of Potash (0-0-60)", "cost_per_bag": 1350, "application_rate_per_hectare": 2},
    {"name": "DAP (18-46-0)", "cost_per_bag": 1420, "application_rate_per_hectare": 2.5},
    {"name": "NPK (16-16-16)", "cost_per_bag": 1200, "application_rate_per_hectare": 3.5},
    {"name": "Organic Compost", "cost_per_bag": 180, "application_rate_per_hectare": 20},
    {"name": "Chicken Manure", "cost_per_bag": 120, "application_rate_per_hectare": 25},
    {"name": "Foliar Fertilizer", "cost_per_bag": 850, "application_rate_per_hectare": 1},
    {"name": "Lime (Agricultural)", "cost_per_bag": 95, "application_rate_per_hectare": 10}
]

# Loan status options
loan_statuses = ["Approved", "Pending", "Under Review", "Disbursed", "Partially Disbursed", "Completed"]
...
def generate_phone_number():
    ...
    prefixes = ["0917", "0918", "0919", "0920", "0921", "0922", "0923", "0924", "0925", "0926", "0927", "0928", "0929"]
    return f"{random.choice(prefixes)}{random.randint(1000000, 9999999)}"

def generate_email(first_name, last_name):
    """Generate a realistic email address"""
    domains = ["gmail.com", "yahoo.com", "hotmail.com", "outlook.com"]
    return f"{first_name.lower()}.{last_name.lower()}.fictitious@{random.choice(domains)}"
...
def calculate_loan_amount(crop, farm_size, fertilizer):
    ...
    fertilizer_cost = fertilizer["cost_per_bag"] * fertilizer["application_rate_per_hectare"] * farm_size
...
def generate_farmer_data():
    ...
    return {
        ...
        "crop_cycle_months": crop["cycle_months"],
        "fertilizer_type": fertilizer["name"],
        "fertilizer_cost_per_bag": fertilizer["cost_per_bag"],
        "fertilizer_bags_needed": fertilizer["application_rate_per_hectare"] * farm_size,
    ...
    try:
        cursor.execute("""
            INSERT INTO farmers (
                ...
                crop_type, agscore, registration_date, last_activity, notes
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        """, (
...
def main():
    ...
    print("Generating 2500 fictitious farmers...")
    ...
    for i in range(2500):
        if i % 100 == 0:
            print(f"Progress: {i}/2500 farmers generated...")
    ...
    print(f"Total farmers in database: {successful_inserts}")
    
    # Generate summary statistics
    cursor.execute("SELECT COUNT(*) FROM farmers WHERE notes LIKE '%FICTITIOUS DATA%'")
    fictitious_count = cursor.fetchone()[0]
    
    cursor.execute("SELECT crop_type, COUNT(*) FROM farmers WHERE notes LIKE '%FICTITIOUS DATA%' GROUP BY crop_type")
    crop_distribution = cursor.fetchall()
    
    cursor.execute("SELECT loan_status, COUNT(*) FROM farmers WHERE notes LIKE '%FICTITIOUS DATA%' GROUP BY loan_status")
