...
def initialize_farmer_database():
    ...
    try:
        ...
        if farmer_count == 0:
            ...
            farmers_data = [
                (
                    ...
                    "Barangay San Jose, Cabanatuan City",
                    "Rice",
                    2.5,
                    45000.0,
                    "ACTIVE",
                ...
                (
                    ...
                    "Barangay Santa Rosa, Nueva Ecija",
                    "Corn",
                    3.0,
                    60000.0,
                    "ACTIVE",
                ...
                (
                    ...
                    "Barangay Bagong Silang, Bulacan",
                    "Rice",
                    4.0,
                    80000.0,
                    "ACTIVE",
        ...
        for farmer_id, loan_amount in farmers:
            ...
            cursor.execute(
                "SELECT COUNT(*) FROM payments WHERE farmer_id = ?", (farmer_id,)
            )
        ...
        cursor.execute(
            "SELECT COUNT(*) FROM users WHERE username = ?", ("carloslopez",)
        )
        ...
        if user_count == 0:
            ...
            password_hash = hashlib.sha256(b"farmer123").hexdigest()
