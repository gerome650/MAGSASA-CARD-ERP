...
def add_sample_orders():
    ...
    with app.app_context():
        ...
        if not farmers or not products:
            print("❌ No farmers or products found. Please run the database initialization first.")
            return
        ...
        db.session.commit()
        print(f"✅ Added 25 sample orders")
...
def add_sample_partners():
    ...
    with app.app_context():
        ...
        partner_types = ['Logistics', 'Supplier', 'Financial', 'Technology', 'Insurance']
