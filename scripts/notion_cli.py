...
def create_validate_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Validate Notion database schemas only",
        add_help=False
    )
    return parser
...
def create_sync_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Run Notion sync operations",
        add_help=False
    )
...
def main():
    ...
    try:
        ...
        # argparse raises SystemExit for help/errors, we want to preserve the exit code
