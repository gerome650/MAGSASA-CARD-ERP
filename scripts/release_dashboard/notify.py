...
class SlackNotifier:
    ...
    def __init__(self, webhook_url: Optional[str] = None, verbose: bool = False):
        """
    ...
    def send_readiness_alert(
        ...
        failing_workflows: Optional[List[Dict[str, Any]]] = None,
    ...
    def send_custom_message(self, text: str, attachments: Optional[List[Dict]] = None) -> bool:
        """
