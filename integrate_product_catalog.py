...
def create_sample_categories():
    ...
    categories_data = [
        # Main categories
        {'name': 'Fertilizers', 'description': 'Chemical and organic fertilizers for crop nutrition'},
        {'name': 'Seeds', 'description': 'High-quality seeds for various crops'},
        {'name': 'Pesticides', 'description': 'Pest control products for crop protection'},
        {'name': 'Herbicides', 'description': 'Weed control products'},
        {'name': 'Tools & Equipment', 'description': 'Agricultural tools and farming equipment'},
    ...
    subcategories_data = [
        ...
        {'name': 'NPK Fertilizers', 'parent': 'Fertilizers', 'description': 'Nitrogen, Phosphorus, Potassium fertilizers'},
        {'name': 'Urea', 'parent': 'Fertilizers', 'description': 'Nitrogen-rich urea fertilizers'},
        {'name': 'Organic Fertilizers', 'parent': 'Fertilizers', 'description': 'Natural and organic fertilizers'},
        {'name': 'Micronutrients', 'parent': 'Fertilizers', 'description': 'Essential micronutrient fertilizers'},
        
        # Seed subcategories
        {'name': 'Rice Seeds', 'parent': 'Seeds', 'description': 'High-yield rice varieties'},
        {'name': 'Corn Seeds', 'parent': 'Seeds', 'description': 'Hybrid corn varieties'},
        {'name': 'Vegetable Seeds', 'parent': 'Seeds', 'description': 'Various vegetable seeds'},
        
        # Pesticide subcategories
        {'name': 'Insecticides', 'parent': 'Pesticides', 'description': 'Insect control products'},
        {'name': 'Fungicides', 'parent': 'Pesticides', 'description': 'Fungal disease control'},
        
        # Tool subcategories
        {'name': 'Hand Tools', 'parent': 'Tools & Equipment', 'description': 'Manual farming tools'},
        {'name': 'Power Tools', 'parent': 'Tools & Equipment', 'description': 'Motorized farming equipment'},
    ]
