...
class Farmer(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'crop_type': self.crop_types.split(',')[0].strip() if self.crop_types else 'N/A',
            'farm_size': self.land_size_ha,
            'barangay': self.address.split(',')[0] if self.address and ',' in self.address else self.address,  # Extract barangay from address
