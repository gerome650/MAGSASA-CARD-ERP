...
def manager_dashboard():
    ...
    try:
        with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'manager_dashboard.html'), 'r') as f:
            return f.read()
...
def officer_dashboard():
    ...
    try:
        with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'officer_dashboard.html'), 'r') as f:
            return f.read()
    except FileNotFoundError:
...
def farmer_dashboard():
    ...
    try:
        with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'farmer_dashboard.html'), 'r') as f:
            return f.read()
    except FileNotFoundError:
...
def admin_dashboard():
    ...
    try:
        with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'index.html'), 'r') as f:
            return f.read()
    except FileNotFoundError:
...
def get_farmer_stats():
    try:
        ...
        loan_status_stats = db.session.query(
            Farmer.loan_status,
            func.count(Farmer.id).label('count')
        ).group_by(Farmer.loan_status).all()
