...
def get_farmer_stats():
    try:
        ...
        ).filter(Farmer.is_active).group_by(Farmer.loan_status).all()
        ...
        agscore_stats = db.session.query(
            ...
            and_(Farmer.is_active, Farmer.agscore_grade.isnot(None))
        ...
        location_stats = db.session.query(
            ...
            and_(Farmer.is_active, Farmer.barangay.isnot(None))
