            ...
            for order in orders:
                ...
                for item in order.items:
                    ...
                    order_items.append({
                        ...
                        "category": product.category.name if product and product.category else "Unknown",
    ...
    def prequalify_farmer(farmer_name, location, crop, land_size_ha, loan_amount_requested):
        ...
        try:
            ...
            if crop.lower() in ['rice', 'palay']:
                ...
                recommendations.append("Rice farming is well-supported with established markets")
                ...
                recommendations.append("Vegetable farming requires careful market timing")
            else:
                qualification_score += 10
