...
class ChaosInjector:
    ...
    def __init__(self, config_path: str = "deploy/chaos_scenarios.yml",
                 target_url: str = None, dry_run: bool = False):
            ...
            async with aiohttp.ClientSession() as session:
                async with session.get(
                    ...
                    if resp.status == 200:
                        ...
                        return (data.get('healthy', False) or 
    ...
    async def simulate_scenario(self, scenario: Dict) -> Dict:
        ...
        if self.dry_run:
            ...
            if not service_available:
                self.logger.warning(f"   Service became unavailable during {scenario_name}")
        ...
        result = {
            ...
            "error_message": None,
            "metrics": {
                "service_available": True  # Assume service recovers
            }
        }
    ...
    async def run_scenarios(self, scenario_filter: str = None, 
                           intensity_filter: str = None) -> List[Dict]:
        """Run chaos scenarios."""
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Chaos Injector - Stage 6.5"
    )
    ...
    parser.add_argument("--scenario", type=str,
                       help="Run specific scenario (partial name match)")
    ...
    print(f"🧪 Starting chaos injection")
