...
def create_tables_and_data():
    ...
    try:
        ...
        roles = [
            ...
            (
                "CARD MRI Manager",
                "Branch/Regional manager with oversight and approval capabilities",
            ),
            (
                "CARD MRI Officer",
                "Loan officer with farmer management and loan processing capabilities",
            ),
        ]
