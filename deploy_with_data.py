...
def populate_sample_data():
    ...
    sample_farmers = [
        ("Juan", "Santos", "juan.santos.demo@fictitious.com", "09171234567", "Cabanatuan, Nueva Ecija", 2.5, "Rice", "Wet", "Urea (46-0-0)", 3750.0, 87500.0, "Approved", 750),
        ("Maria", "Cruz", "maria.cruz.demo@fictitious.com", "09181234567", "Dagupan, Pangasinan", 1.8, "Corn", "Dry", "Complete (14-14-14)", 8496.0, 50400.0, "Disbursed", 820),
        ("Pedro", "Reyes", "pedro.reyes.demo@fictitious.com", "09191234567", "Iloilo City, Iloilo", 3.2, "Sugarcane", "Plant", "NPK (16-16-16)", 13440.0, 272000.0, "Pending", 680),
        ("Ana", "Garcia", "ana.garcia.demo@fictitious.com", "09201234567", "Bacolod, Negros Occidental", 1.5, "Banana", "Year-round", "Organic Compost", 5400.0, 67500.0, "Under Review", 710),
        ("Jose", "Mendoza", "jose.mendoza.demo@fictitious.com", "09211234567", "Naga, Camarines Sur", 2.0, "Coconut", "Year-round", "Chicken Manure", 6000.0, 30000.0, "Approved", 650)
    ]
    ...
    for i, farmer_data in enumerate(sample_farmers):
        ...
        """, farmer_data + (reg_date, last_activity, "DEMO DATA - Sample farmer for testing"))
    
    # Generate additional farmers to reach 2500
    first_names = ["Juan", "Maria", "Jose", "Ana", "Pedro", "Carmen", "Antonio", "Rosa", "Manuel", "Elena"]
    last_names = ["Santos", "Cruz", "Reyes", "Garcia", "Mendoza", "Torres", "Flores", "Ramos", "Aquino", "Valdez"]
    crops = ["Rice", "Corn", "Sugarcane", "Banana", "Coconut", "Coffee", "Cacao", "Mango"]
    ...
    for i in range(2495):  # 2500 - 5 sample farmers
        ...
        """, (first_name, last_name, email, phone, address, farm_size, crop_type, 
              loan_amount, agscore, reg_date, last_activity, "DEMO DATA - Generated for testing"))
