    ...
    try:
        ...
        if farmers:
            ...
            for farmer in farmers[:3]:  # Show first 3
                print(
                    f"   • {farmer[1]} - {farmer[5]} farmer, {farmer[6]}ha, AgScore: {farmer[9]}"
                )
        else:
        ...
        print(
            f"✅ Filtering Options: Location ({len(locations)}), Crop ({len(crops)}), Status ({len(statuses)})"
        )
        ...
        print("   • Export format: CSV/JSON compatible")
        ...
        print("✅ AgScore System: Credit scoring functional")
...
def test_loan_management_system():
    ...
    try:
        ...
        cursor.execute(
            "SELECT farmer_id, loan_amount FROM farmers WHERE loan_amount > 0"
        )
        ...
        print("✅ Interest Calculation: Accurate computation functional")
...
def test_product_inventory():
    ...
    try:
        ...
        for product in products:
            print(
                f"   • {product['name']} - {product['category']} - ₱{product['price']}"
            )
        ...
        print("✅ Inventory Tracking: Stock monitoring functional")
        ...
        for supplier in suppliers:
            print(
                f"   • {supplier['name']} - {supplier['products']} products - {supplier['rating']}★"
            )
...
def test_partnership_network():
    ...
    try:
        ...
        partners = [
            ...
            {
                "name": "Provincial Buyers Coop",
                "type": "Buyer",
                "orders": 78,
                "performance": 88,
            },
            {
                "name": "AgriTransport Inc",
                "type": "Transport",
                "orders": 32,
                "performance": 95,
            },
        ...
        for partner in partners:
            print(
                f"   • {partner['name']} - {partner['type']} - {partner['performance']}% performance"
            )
        ...
        print("✅ Order Processing: Partner order workflow functional")
        print(f"   • Total orders processed: {total_orders}")
        print(f"   • Average orders per partner: {avg_orders:.1f}")
        print("   • Order workflow: Active")

        # Test 6.4.3: Logistics Coordination - Delivery and transport management
        print("\n🚚 Test 6.4.3: Logistics Coordination")
        logistics_partners = [
            p for p in partners if p["type"] in ["Logistics", "Transport"]
        ]

        print(
            f"✅ Logistics Coordination: {len(logistics_partners)} logistics partners"
        )
        ...
        print("✅ Performance Tracking: Partner metrics monitoring")
...
def test_financial_reporting():
    ...
    try:
        ...
        print("✅ Financial Dashboard: Revenue and expense tracking")
        ...
        collection_rate = (
            (total_payments_received / total_loans_disbursed * 100)
            if total_loans_disbursed > 0
            else 0
        )

        print("✅ Loan Portfolio: Performance analytics functional")
        ...
        medium_risk = sum(
            count for score, count in risk_distribution if 700 <= score < 800
        )
        low_risk = sum(count for score, count in risk_distribution if score >= 800)

        print("✅ Risk Assessment: Credit risk analysis functional")
        ...
        print("✅ Regulatory Reports: Compliance reporting functional")
